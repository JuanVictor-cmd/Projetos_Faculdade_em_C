/* Foi realizada uma pesquisa de algumas características físicas da população de uma certa região, a qual coletaram os seguintes dados
...
main()
{
    ...
    printf("\n quantidade feminina entre 18 e 35 anos: %d ",q1);
